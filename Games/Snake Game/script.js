      ...
      function renderFood() {
        ...
        if (cell) {
          // Make food fully filled with solid color
          ...
          cell.style.border = 'none'; // Remove any potential border
          ...
          if (!document.querySelector('style#food-animation')) {
            ...
            style.textContent = `
              @keyframes pulse {
                0% { transform: scale(0.8); box-shadow: 0 0 5px var(--food-color); }
                70% { transform: scale(1); box-shadow: 0 0 15px var(--food-color); }
                100% { transform: scale(0.8); box-shadow: 0 0 5px var(--food-color); }
              }
            `;
